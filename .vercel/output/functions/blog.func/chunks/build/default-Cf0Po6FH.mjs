...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main flex flex-col justify-start items-center max-w="var(--content-width)" w-full py="128px" style="${ssrRenderStyle({ "min-height": "calc(100vh - 48px)" })}" relative>`);
...
//# sourceMappingURL=default-Cf0Po6FH.mjs.map
