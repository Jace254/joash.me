...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "05e7d4c4-236d-4110-89be-f2202f54dfd6",
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "C:/Users/Joash/Documents/Code/Personal/Me/joash.me/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  }
};
...
const _87vh9zWm9b6dF4Kij67PiaHjGZ1mbSUL0WVC19zXJg = (function(nitro) {
...
const plugins = [
  _87vh9zWm9b6dF4Kij67PiaHjGZ1mbSUL0WVC19zXJg
];

const _SxA8c9 = defineEventHandler(() => {});

const _3LvAsB = eventHandler(async (event) => {
...
const checksumsStructure = {
  "blog": "SOMfmq38jURl7lqnyLkfxr-Xrf37Z7SFCpgHzK_jewU",
  "home": "NjTvq1w5q36mXjJo2zqY0QPa_nWa0Xx2E5lX6YgtdO8"
};
...
const _R3wV4J = eventHandler(async (event) => {
...
const _lazy_EmSZ5m = () => import('../routes/index.mjs');
const _lazy_219wXC = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/og', handler: _lazy_EmSZ5m, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_219wXC, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump.txt', handler: _3LvAsB, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _R3wV4J, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_219wXC, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, toRouteMatcher as A, createRouter$1 as B, defu as C, pascalCase as D, kebabCase as E, withLeadingSlash as F, useRuntimeConfig as a, buildAssetsURL as b, createError$1 as c, defineEventHandler as d, getResponseStatus as e, defineRenderHandler as f, getResponseStatusText as g, publicAssetsURL as h, getQuery as i, destr as j, getRouteRules as k, hasProtocol as l, joinURL as m, getContext as n, withTrailingSlash as o, parseQuery as p, withoutTrailingSlash as q, relative as r, isScriptProtocol as s, toNodeListener as t, useNitroApp as u, sanitizeStatusCode as v, withQuery as w, baseURL as x, createHooks as y, executeAsync as z };
