...
import { D as pascalCase, E as kebabCase, j as destr } from '../_/nitro.mjs';
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxtjs+mdc@0.17.4/node_modules/@nuxtjs/mdc/dist/runtime/components/MDCRenderer.vue");
...
const virtual_nuxt_C_3A_2FUsers_2FJoash_2FDocuments_2FCode_2FPersonal_2FMe_2Fjoash_me_2Fnode_modules_2F_cache_2Fnuxt_2F_nuxt_2Fcontent_2Fcomponents = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  globalComponents,
  localComponents
    ...
    function resolveVueComponent(component) {
      ...
      if (typeof component === "string") {
        ...
        if (globalComponents.includes(pascalCase(component))) {
          ...
          const loader = () => {
            return Promise.resolve().then(() => virtual_nuxt_C_3A_2FUsers_2FJoash_2FDocuments_2FCode_2FPersonal_2FMe_2Fjoash_me_2Fnode_modules_2F_cache_2Fnuxt_2F_nuxt_2Fcontent_2Fcomponents).then((m) => {
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxt+content@3.7.1_better-sqlite3@12.4.1/node_modules/@nuxt/content/dist/runtime/components/ContentRenderer.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const __nuxt_component_1 = Object.assign(_sfc_main, { __name: "ContentRenderer" });

export { __nuxt_component_1 as _ };
//# sourceMappingURL=ContentRenderer-COeWdKRA.mjs.map
