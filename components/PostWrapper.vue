...
<template>
  <div
    ...
    class="prose my-auto mb-8  w-full md:px-0 px-7"
  ...
  >
    ...
    >
      {{ formatDate(frontmatter.date, false) }} · <span v-if="frontmatter.duration" class="before:i-material-symbols-timer-outline-rounded">{{ frontmatter.duration }}</span>
    </p>
  ...
  <div v-if="route.path !== '/'" class="prose m-auto w-full md:px-0 px-7 mt-8 mb-8 slide-enter animate-delay-500 print:hidden">
