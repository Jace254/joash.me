...
const u0 = l0(), [Yi, S2] = xr("ConfigProvider");
...
const Ru = (e) => typeof e == "boolean" ? "".concat(e) : e === 0 ? "0" : e, Du = my, vy = (e, t) => (n) => {
...
}), Be = (e) => (cc("data-v-b59367ed"), e = e(), dc(), e), Iy = {
  key: 0,
  ...
  for (const [o, r] of t)
    n[o] = r;
  return n;
}, f2 = /* @__PURE__ */ p2(d2, [["__scopeId", "data-v-b59367ed"]]), h2 = /* @__PURE__ */ Oi({ ...f2, styles: [Hm] });
function m2() {
  typeof window > "u" || customElements.define("hotspot-standard", h2);
}
function v2(e) {
